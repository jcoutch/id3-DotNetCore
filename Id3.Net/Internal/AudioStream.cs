...
namespace Id3.Internal
{
    internal sealed class AudioStream
    {
        ...
        private bool IsValidHeader
        {
            get
            {
                return ((FrameSync & 2047) == 2047) && ((VersionIndex & 3) != 1) && ((LayerIndex & 3) != 0) && ((BitrateIndex & 15) != 0) &&
        ...
        {
            get { return FrequencyLookup[VersionIndex, FrequencyIndex]; }
        }
        #endregion
        ...
        {
            get { return (int)((_bitHeader >> 12) & 15); }
        }

        private int EmphasisIndex
        {
            get { return (int)(_bitHeader & 3); }
        }
        ...
        {
            get { return (int)((_bitHeader >> 21) & 2047); }
        }

        private int FrequencyIndex
        {
            get { return (int)((_bitHeader >> 10) & 3); }
        }

        private int LayerIndex
        {
            get { return (int)((_bitHeader >> 17) & 3); }
        }

        private int ModeIndex
        {
            get { return (int)((_bitHeader >> 6) & 3); }
        }

        private int VersionIndex
        {
            get { return (int)((_bitHeader >> 19) & 3); }
        }
        #endregion
    }
}