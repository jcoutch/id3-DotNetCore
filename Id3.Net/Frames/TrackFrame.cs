    ...
    public sealed class TrackFrame : TextFrameBase<int>
    {
        ...
        internal override string TextValue
        {
            get
            {
                ...
                if (Value <= 0)
                    return string.Format("0/{0}", TrackCount);
                return string.Format("{0}/{1}", Value, TrackCount);
            }
            set
            {
                ...
                } else
                {
                    ...
                    } else
                    {
                        ...
                        TrackCount = !string.IsNullOrEmpty(match.Groups[2].Value) ? int.Parse(match.Groups[2].Value) : 0;
                    }
                }
            }
        }
